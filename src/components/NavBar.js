  ...
  return (
    <nav className="sticky top-0 z-50 bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://www.ugto.mx/index.php" className="flex items-center space-x-3 rtl:space-x-reverse">
          <Image src="/images/escudo-horizontal-png.png" className="h-12" alt="UGTO Logo" width={150} height={50} style={{ width: '100%', height: 'auto' }} priority />
        </a>
        <a href="https://libreriaug.ugto.mx/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <Image src="/images/logo_libreria.png" alt="Librería Logo" width={150} height={50} style={{ width: '100%', height: 'auto' }} />
        </a>
        <div className="flex md:order-2">
          <button onClick={() => setIsOpen(!isOpen)} type="button" aria-controls="navbar-search" aria-expanded={isOpen} className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1">
            <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
              <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5h14M3 10h14M3 15h14" />
            </svg>
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link href="/" passHref>
                <span
                  ...
                  className={`block py-2 px-3 text-[#003c71] ${currentPath === "/" && isVisible ? "animate__animated animate__hinge" : ""} font-semibold`}
            ...
            <li>
              <Link href="/register">
                <span
                  onClick={handleAnimation}
                  className={`block py-2 px-3 text-[#003c71] ${currentPath === "/register" && isVisible ? "animate__animated animate__hinge" : ""} font-semibold`}
                >
                  Regístrate
                </span>
              </Link>
            ...
            <li>
              <Link href="/catalog">
                <span
                  onClick={handleAnimation}
                  className={`block py-2 px-3 text-[#003c71] ${currentPath === "/catalog" && isVisible ? "animate__animated animate__hinge" : ""} font-semibold`}
