...
const PanelReader = () => {
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl text-blue font-bold mb-4">Panel del Lector</h1>
      ...
      <div className="hexagon-container">
        ...
        >
          ...
          <div>
            ...
            <p className="text-blue text-sm">Solicitar Libros.</p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-blue text-sm">
              Solicitud de Visitas al Archivo Historico
            </p>
          </div>
        </div>
      </div>
